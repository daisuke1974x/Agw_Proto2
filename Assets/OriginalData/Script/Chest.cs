...
public class Chest : MonoBehaviour
{
    ...
    private void DropControl()
    {
        ...
        if (0<= Rnd && Rnd < 60)
        {
            ...
            if (0<=Rnd&&Rnd < 50)
            {
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 0, 0);
            ...
            {
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 0, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 1, 0, 0, 0);
                FragmentListScript.AddList(StockName);
                return;
            }
            if (70 <= Rnd && Rnd < 80)
            ...
            if (80 <= Rnd && Rnd < 85)
            {
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 0, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 1, 0, 0, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 1, 0);
                FragmentListScript.AddList(StockName);
                return;
            }
            if (85 <= Rnd && Rnd < 88)
            {
                ...
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 1, 0, 0, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 1, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 2, 0);
                FragmentListScript.AddList(StockName);
                return;
            }
            if (88 <= Rnd && Rnd < 91)
            ...
            {
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 0, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 1, 0, 1, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 0, 0, 1, 0);
                MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Green", 1, 0, 0, 0);
                FragmentListScript.AddList(StockName);
                return;
        ...
        if (60 <= Rnd && Rnd < 90)
        {
            ...
            if (0 <= Rnd && Rnd < 70)
            {
                ...
                if (0 <= Rnd && Rnd < 50)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road1", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (50 <= Rnd && Rnd < 60)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road0", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (60 <= Rnd && Rnd < 80)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road2", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (80 <= Rnd && Rnd < 95)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road3", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (95 <= Rnd && Rnd < 100)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road4", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
            ...
            if (70 <= Rnd && Rnd < 100)
            {
                ...
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road1", 0, 0, 0, 0);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road1", 1, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (50 <= Rnd && Rnd < 70)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road2", 0, 0, 0, 0);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road1", 1, 0, 0, 1);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (70 <= Rnd && Rnd < 90)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road2", 0, 0, 0, 2);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road1", -1, 0, 0,1);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                ...
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road3", 0, 0, 0, 0);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "Road1", 0, 0, 1, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
            }
        ...
        if (90 <= Rnd && Rnd < 100)
        {
            ...
            if (0 <= Rnd && Rnd < 60)
            {
                ...
                if (0 <= Rnd && Rnd < 60)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River1", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                ...
                if (60 <= Rnd && Rnd < 80)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River2", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                ...
                if (80 <= Rnd && Rnd < 90)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "RiverBridge", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                ...
                if (90 <= Rnd && Rnd < 100)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River3", 0, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
            ...
            if (60 <= Rnd && Rnd < 100)
            {
                ...
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River1", 0, 0, 0, 0);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River1", 0, 0, 1, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (60 <= Rnd && Rnd < 80)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River1", 0, 0, 1, 0);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River2", 0, 0, 0, 3);
                    FragmentListScript.AddList(StockName);
                    return;
                ...
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River1", 0, 0, 1, 0);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River2", 0, 0, 0, 2);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (90 <= Rnd && Rnd < 94)
                {
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River3", 0, 0, 0, 0);
                    MainControl.GetComponent<MainControl>().LoadFieldParts(StockName, "River1", -1, 0, 0, 0);
                    FragmentListScript.AddList(StockName);
                    return;
                }
                if (94 <= Rnd && Rnd < 98)
